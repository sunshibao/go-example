...
//110万
//ObjectId("6148a7f266de4b663ae0876d")
//haiden.com.controld
func shell(mongodb *mgo.Session, database string, skip, limit int) (err error) {
	...
	c.Find(bson.M{"_id": bson.M{"$gt": bson.ObjectIdHex("6148a7f266de4b663ae0876d")}}).Sort("_id").Skip(skip).Limit(limit).All(&mongoAppInfos)
