...
//40万
//ObjectId("61433dc083a13634e98d3fb2")
//com.hltcorp.femechanical
func shell(mongodb *mgo.Session, database string, skip, limit int) (err error) {
	...
	c.Find(bson.M{"_id": bson.M{"$gt": bson.ObjectIdHex("61433dc083a13634e98d3fb2")}}).Sort("_id").Skip(skip).Limit(limit).All(&mongoAppInfos)
