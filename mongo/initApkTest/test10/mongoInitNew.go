...
//100万
//ObjectId("6147a92166de4b663ab4b21a")
//com.nashschultz.sketchit
func shell(mongodb *mgo.Session, database string, skip, limit int) (err error) {
	...
	c.Find(bson.M{"_id": bson.M{"$gt": bson.ObjectIdHex("6147a92166de4b663ab4b21a")}}).Sort("_id").Skip(skip).Limit(limit).All(&mongoAppInfos)
