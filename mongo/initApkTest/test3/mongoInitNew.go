...
//30万
//ObjectId("611a5322d0cb9aafc5281c35")
//com.tribunegamesmobilestudios.underwater.raft.survival.escape.story
func shell(mongodb *mgo.Session, database string, skip, limit int) (err error) {
	...
	c.Find(bson.M{"_id": bson.M{"$gt": bson.ObjectIdHex("611a5322d0cb9aafc5281c35")}}).Sort("_id").Skip(skip).Limit(limit).All(&mongoAppInfos)
