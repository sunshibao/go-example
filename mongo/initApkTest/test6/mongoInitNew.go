...
//60万
//ObjectId("614455b966de4b663a234dc4")
//com.teamviewer.quicksupport.addon.M3_SL10
func shell(mongodb *mgo.Session, database string, skip, limit int) (err error) {
	...
	c.Find(bson.M{"_id": bson.M{"$gt": bson.ObjectIdHex("614455b966de4b663a234dc4")}}).Sort("_id").Skip(skip).Limit(limit).All(&mongoAppInfos)
