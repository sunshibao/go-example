...
//120万
//ObjectId("6173b6ccdc5a634655f645d8")
//tw.com.ukeas.leadmanagerpro.android
func shell(mongodb *mgo.Session, database string, skip, limit int) (err error) {
	...
	c.Find(bson.M{"_id": bson.M{"$gt": bson.ObjectIdHex("6173b6ccdc5a634655f645d8")}}).Sort("_id").Skip(skip).Limit(limit).All(&mongoAppInfos)
