...
//ObjectId("61979932685adbd671d44eb7")
func shell(mongodb *mgo.Session, database string, skip, limit int) (err error) {
	...
	c.Find(bson.M{"_id": bson.M{"$gt": bson.ObjectIdHex("61979932685adbd671d44eb7")}}).Sort("_id").Skip(skip).Limit(limit).All(&mongoAppInfos)
