...
//50万
//ObjectId("614423a066de4b663a12bf82")
//com.chownow.limerickstavern
func shell(mongodb *mgo.Session, database string, skip, limit int) (err error) {
	...
	c.Find(bson.M{"_id": bson.M{"$gt": bson.ObjectIdHex("614423a066de4b663a12bf82")}}).Sort("_id").Skip(skip).Limit(limit).All(&mongoAppInfos)
