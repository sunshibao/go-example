...
//70万
//ObjectId("6144b1a866de4b663a3f5f3c")
//com.newandromo.dev767957.app871111
func shell(mongodb *mgo.Session, database string, skip, limit int) (err error) {
	...
	c.Find(bson.M{"_id": bson.M{"$gt": bson.ObjectIdHex("6144b1a866de4b663a3f5f3c")}}).Sort("_id").Skip(skip).Limit(limit).All(&mongoAppInfos)
