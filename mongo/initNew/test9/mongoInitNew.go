...
//90万
//ObjectId("6145608266de4b663a74f780")
//com.hsn.digitalcounter
func shell(mongodb *mgo.Session, database string, skip, limit int) (err error) {
	...
	c.Find(bson.M{"_id": bson.M{"$gt": bson.ObjectIdHex("6145608266de4b663a74f780")}}).Sort("_id").Skip(skip).Limit(limit).All(&mongoAppInfos)
