...
//80万
//ObjectId("6144fcc266de4b663a569f62")
//com.gofrugal.ordereasy654274
func shell(mongodb *mgo.Session, database string, skip, limit int) (err error) {
	...
	c.Find(bson.M{"_id": bson.M{"$gt": bson.ObjectIdHex("6144fcc266de4b663a569f62")}}).Sort("_id").Skip(skip).Limit(limit).All(&mongoAppInfos)
