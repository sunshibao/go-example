...
func getRootKey() string {
	...
	first := strings.Trim(ReadFile("aes/honor/honor/honord/k.txt"), "")
	second := strings.Trim(ReadFile("aes/honor/honor/honorw/k.txt"), "")
	salt := strings.Trim(ReadFile("aes/honor/honor/honors/s.txt"), "")
